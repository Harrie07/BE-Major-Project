...
class Settings(BaseSettings):
    ...
    EMAILS_FROM_EMAIL: Optional[str] = Field(default=None, description="Email from address")
    EMAILS_FROM_NAME: Optional[str] = Field(default=None, description="Email from name")
    ...
    # These are explicitly defined to prevent 'Extra inputs are not permitted' errors
    ...
    class Config:
        ...
        case_sensitive = True
        # --- ALLOW EXTRA FIELDS ---
        # This prevents the ValidationError for extra environment variables
        extra = "allow"
